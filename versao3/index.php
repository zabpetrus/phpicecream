...
<html lang="en">
    <head>
        <title>XMLHttpRequest / SQL </title>
        <meta charset="UTF-8">		
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link href="css/style.css" rel="stylesheet" type="text/css"  name="style1">
    ...
    <body>
        ...
        <section>        
			...
			<div class='redirecionar' ><a href="população/index.php">Criar banco de Dados</a></div>
			
            <form id="formulario" action="response.php">

                <h2>XMLHttpRequest Com SQL </h2>
